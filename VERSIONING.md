...
|---|---|---|---|---|
| v1.2.4 | 2026-09-04 | À compléter | Correctif de régression : restauration des références DOM `statusMsg`, `templateSelect` et `templateNameInput` perdues dans `js/main.js`, supprimant la `ReferenceError` dans `refreshTemplateList`. Aucune autre logique modifiée. | en cours |
