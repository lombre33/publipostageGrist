...
|---|---|---|---|---|
| v1.2.3 | 2026-09-04 | À compléter | Correctif définitif du bandeau Select By : suppression du faux positif onRecord initial ; détection par options.linking.asTarget avec logs bruts explicites, et repli sans polling par confirmation utilisateur persistée via grist.setOption. Le bandeau reste contextuel au mode lecture et disparaît automatiquement quand Select By est confirmé. Fonctions d’édition, autocomplete, modèles, export PDF et résolution dynamique inchangées. | en cours |
